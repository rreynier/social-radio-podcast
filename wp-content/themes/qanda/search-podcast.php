<?php get_header(); ?>
    ...
    <?php
    global $wp_query;
    printf( __( "Search results (%s) for:", "kazaz" ), $wp_query->found_posts );
    echo ' <span class="normal-italic">' . esc_attr( $_GET[ 's' ] ) . '</span>';
    ?>
    </div>
    ...
    <?php get_template_part( 'sidebars/sidebar-search_podcast' ); // sidebar ?>
