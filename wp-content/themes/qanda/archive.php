<?php get_header(); ?>
	...
	<?php if ( is_day() ) : ?>
		<?php printf( __( "Daily Archives: %s", "kazaz" ), '<span class="normal-italic">' . get_the_date() . '</span>' ); ?>
	<?php elseif ( is_month() ) : ?>
		<?php printf( __( "Monthly Archives: %s", "kazaz" ), '<span class="normal-italic">' . get_the_date( _x( "F Y", "monthly archives date format", "kazaz" ) ) . '</span>' ); ?>
	<?php elseif ( is_year() ) : ?>
		<?php printf( __( "Yearly Archives: %s", "kazaz" ), '<span class="normal-italic">' . get_the_date( _x( "Y", "yearly archives date format", "kazaz" ) ) . '</span>' ); ?>
	<?php else : ?>
		<?php _e( "Blog Archives", "kazaz" ); ?>
	<?php endif; ?>
    </div>
    ...
    <?php get_template_part( 'sidebars/sidebar-archives' ); // sidebar ?>
