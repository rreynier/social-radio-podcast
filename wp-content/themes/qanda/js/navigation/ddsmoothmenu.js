...
buildmenu:function($, setting){
	...
	$headers.each(function(i){ //loop through each LI header
		...
		$subul.css({top:this.istopheader && setting.orientation!='v'? this._dimensions.h+"px" : 0}) // MODIFIED BY DAMEER DJ !!!!!!!!!!!!!!!!!!!!!!!!!
		$curobj.children("a:eq(0)").css(this.istopheader? {paddingRight: smoothmenu.arrowimages.down[2]} : {}).append( //add arrow images
			'<img src="'+ (this.istopheader && setting.orientation!='v'? setting.downarrowpath : setting.rightarrowpath)
