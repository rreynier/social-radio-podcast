...
$ico_path_podcast = get_template_directory_uri() . '/images/podcast.png';

// define meta-box arguments/params for portfolio definition
$args_array = array(
	'label' => __( 'Podcasts', 'kazaz' ),
	'singular_label' => __( 'Podcast', 'kazaz' ),
	'public' => true,
	'query_var' => true,
	'rewrite' => true,
...
sd_register_post_type( 'podcast', $args_array, 'podcasts' );

// add taxonomy aka custom post type category
function sofa_reg_taxonomy() {
	register_taxonomy( 'podcast_category', array( 'podcast' ), array( 'hierarchical' => true, 'label' => 'Podcast Categories', 'singular_label' => 'Podcast Category', 'rewrite' => true ) );
	register_taxonomy( 'podcast_tags', array( 'podcast' ), array( 'hierarchical' => false, 'label' => 'Podcast Tags', 'singular_label' => 'Podcast Tag', 'query_var' => true, 'show_ui' => true, 'rewrite' => array( 'slug' => 'podcast_tags' ) ) );
}
